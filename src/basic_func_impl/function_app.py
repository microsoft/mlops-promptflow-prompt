...
from class_function import bp as bp_class_based_invoke
from function_function import bp as bp_function_based_invoke
from yaml_function import bp as bp_yaml_based_invoke
